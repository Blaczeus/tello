...
<template>
  <button @click="updateAppearance(next.value)"
    class="inline-flex items-center gap-2 rounded-md px-3.5 py-1.5 bg-transparent text-neutral-700 transition-colors hover:bg-accent dark:bg-transparent dark:text-neutral-300 dark:hover:bg-neutral-700">
